...
export const createVideo = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const model = 'gemini-3.1-generate-preview'
        ...
        //create the images directory if it is doent existttttttt !
        fs.mkdirSync('videos', { recursive: true })
        if (!operation.response.generatedVideos) {
            throw new Error(operation.response.raiMediaFilterdReasons[0])
        }
