            ...
            <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
                ...
                <div className={`${gen?.aspectRatio === '9:16' ? 'aspect-9/16' : 'aspect-video'} relative overflow-hidden`}>
                    ...
                    {!forCommunity && (
                        <div
                            ...
                            <div className="absolute top-3 right-3">
                                <EllipsisIcon className="ml-auto bg-black/10 rounded-ful p-1 size-7" />
                            </div>
                    ...
                    <div className="absolute right-3 bottom-3">
                        <img src={gen.uploadedImages[0]} alt="product" className="w-16 h-16 rounded-full object-cover border animate-float" />

                        <img src={gen.uploadedImages[1]} alt="product" className="w-16 h-16 rounded-full object-cover border animate-float -ml-8" style={{ animationDelay: '3s' }} />
                    </div>
                </div>
                ...
                <div className="p-4">
                    <div className="flex items-center justify-between gap-4">
                        <div className="flex-1">
                            ...
                            {gen.updatedAt && (
                                <p className="t500 mt-1">Updated : {new Date(gen.updatedAt).toLocaleString()}</p>
                            )}
                        </div>
