    ...
    <div className="min-h-screen text-white p-6 md:p-12 mt-20">
      <div className="max-w-6xl mx-auto">
        <header className="flex justify-between items-center mb-8">
          <h1 className="text-2xl md:text-3xl font-medium">Generations Result</h1>
          ...
          <div className="space-y-6">
              ...
              <div className="flex flex-col gap-3">
                <a href={project.generatedImage} download>
                  <GhostButton disabled={!project.generatedImage}
                    ...
                    <ImageIcon className="size-4.5" /> Downlaod Image
                  </GhostButton>
                </a>
                ...
                <a href={project.generatedVideo} download>
                  <GhostButton disabled={!project.generatedVideo}
                    className="w-full justify-center rounded-md py-3 disabled:opacity-50 disabled:cursor-not-allowed">
                    <VideoIcon className="size-4.5" /> Downlaod Video
                  </GhostButton>
                </a>
              </div>
            </div>
            ...
            <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
              ...
              {!project.generatedVideo ? (
                ...
                <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-xl text-center text-sm font-medium text-green-400">Video Generated Successfully !</div>
              )}
            </div>
