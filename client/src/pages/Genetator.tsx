  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          heading="Create In_Context Image"
        ...
        <div className="flex gap-20 max-sm:flex-col items-start justify-between">
          ...
          <div className="w-full">
            ...
            <div className="mb-4 text-gray-300">
              ...
              <textarea id="productDescription" rows={4} value={productDescription} onChange={(e) => setProductDescription(e.target.value)} placeholder="Describe Your Product in Few Words" className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all" />
            </div>

            <div className="mb-4 text-gray-300">
              <label htmlFor="aspectratio" className="block text-sm mb-4">Aspect Ratio </label>
